configStruct = struct( ...
    ...
    'transformMatrix',  [ -0.941609005980, -0.243789644085, -0.232247904823, 476196.846473453159; ...
        0.238074856649, -0.969811967326, 0.052774147671, 3636332.815622795373; ...
        -0.238102588161, -0.005599773918, 0.971223867109, 10.425274673228; ...
...
configStruct = struct( ...
    ...
    'transformMatrix', [ -0.942044394183, -0.232750464950, -0.241618667436, 476196.853540493292; ...
        0.227795128866, -0.972492897292, 0.048651248513, 3636332.813486180268; ...
        -0.246296038646, -0.009207919553, 0.969150904434, 10.399895521865; ...
        0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000 ], ....
     'LidarBoundary', [476190.822581, 476185.016129, 475999.919355, 476029.274194;... 
     3636353.450920, 3636316.937617, 3636300.996933, 3636453.144172]');
...
fwrite(fid, jsonText, 'char');
fclose(fid);
%% For lidar processing 2

load('L2_lidarbounds.mat');
...
configStruct = struct( ...
    ...
    0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000 ], ...
     'LidarBoundary', bounds);

jsonText = jsonencode(configStruct, 'PrettyPrint', true);
fid = fopen('livox_config_L2.json', 'w');
fwrite(fid, jsonText, 'char');
fclose(fid);
...
Tnew_Aug = [ -0.941609005980, -0.243789644085, -0.232247904823, 476196.846473453159; ...
        0.238074856649, -0.969811967326, 0.052774147671, 3636332.815622795373; ...
        -0.238102588161, -0.005599773918, 0.971223867109, 10.425274673228; ...
        0.000000000000, 0.000000000000, 0.000000000000, 1.000000000000 ];
