function [reconstructed_x, reconstructed_y, reconstructed_z, reconstructed_t, reconstructed_I] = accumpts_L2(xyz,t,I, res)
...
% percentabove = 80; % like a minumum surface,
...
% 
% % Remove points over 50cm above the 'ground'
% 
% % Set a threshold for what counts as "ground"
% threshold = 0.001;  % Adjust this value based on your data
% 
...
% filtered_Is = cellfun(@(I, ground) I(~ground), Is, ground_points, 'UniformOutput', false);
...
for i = 1:length(ux)
    for j = 1:length(uy)
        ...
        reconstructed_I = [reconstructed_I; I_values];
    end
end
